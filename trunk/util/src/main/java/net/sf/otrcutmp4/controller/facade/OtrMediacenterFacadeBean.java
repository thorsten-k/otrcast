...
import net.sf.otrcutmp4.controller.web.rss.DefaultUrlGenerator;
...
{	
	...
	@Override public EPISODE fcEpisode(Class<SERIES> clSeries, Class<SEASON> clSeason, Class<EPISODE> clEpisode, Class<IMAGE> clImage, net.sf.otrcutmp4.model.xml.series.Episode xmlEpisode)
	{
	...
	@Override public EPISODE fcEpisode(Class<EPISODE> cEpisode, SEASON season, net.sf.otrcutmp4.model.xml.series.Episode xmlEpisode)
	{
